...
var alertDialog = function ($mdDialog, title, contents, okButtonTitle, callback) {
    ...
    $mdDialog.show(dialogObj).then(callback);
};

var confirmDialog = function ($mdDialog, title, contents, okButtonTitle, cancelButtonTitle, okCallback, cancelCallback) {
    ...
    $mdDialog.show(dialogObj).then(okCallback, cancelCallback);
};